...
const reasons = [
  { icon: Award, title: "Experienced & Certified", description: "Qualified dentist with years of specialized training" },
  { icon: ShieldCheck, title: "Sterilized Environment", description: "Highest standards of hygiene and infection control" },
  { icon: Zap, title: "Latest Technology", description: "Advanced equipment for precise, effective treatments" },
  { icon: Heart, title: "Patient-First Approach", description: "Your comfort and care is our top priority" },
  { icon: Sparkles, title: "Painless Treatments", description: "Modern techniques for comfortable procedures" },
];
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[hsl(210,25%,10%)] via-[hsl(210,25%,14%)] to-[hsl(200,30%,16%)] py-16 md:py-24">
      ...
      <div className="container relative z-10">
        ...
        <StaggerContainer className="flex flex-wrap items-center justify-center gap-6" staggerDelay={0.1}>
          {reasons.map((reason, index) => (
            <StaggerItem key={index}>
              <div className="flex w-[200px] flex-col items-center rounded-2xl border border-white/10 bg-white/5 p-6 text-center backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:bg-white/10">
