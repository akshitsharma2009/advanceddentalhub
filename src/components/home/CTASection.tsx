        ...
        <ScaleReveal>
          <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-gradient-to-br from-secondary/80 to-accent/40 p-8 shadow-[0_16px_48px_-12px_hsl(210_20%_20%/0.15)] backdrop-blur-xl md:p-12 lg:p-16">
            ...
            <ScrollReveal className="relative z-10 mx-auto max-w-3xl text-center">
              <p className="mb-2 text-sm font-medium uppercase tracking-[0.2em] text-primary">Get Started Today</p>
              <h2 className="font-display text-3xl font-bold text-foreground md:text-4xl">Ready to Transform Your Smile?</h2>
